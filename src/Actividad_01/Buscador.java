...
public class Buscador {
    ...
    public static void main(String[] args) {
        ...
        buscador.mostrar_resultado(result, busqueda);
    ...
    public void mostrar_resultado(NodeList result, String busqueda) {
        ...
        if (result != null) {
            ...
            for (int i = 0; i < result.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    String UF1 = String.format("%.2f",
                            Float.parseFloat(element.getElementsByTagName("UF1").item(0).getTextContent()));
                    String UF2 = String.format("%.2f",
                            Float.parseFloat(element.getElementsByTagName("UF2").item(0).getTextContent()));
                    String UF3 = String.format("%.2f",
                            Float.parseFloat(element.getElementsByTagName("UF3").item(0).getTextContent()));
                    // Mostrar los datos
